...
hl.bind(mainMod .. " + CTRL + SHIFT + 1", hl.dsp.exec_cmd("hyprctl switchxkblayout all 0"))
hl.bind(mainMod .. " + CTRL + SHIFT + 2", hl.dsp.exec_cmd("hyprctl switchxkblayout all 1"))
hl.bind(mainMod .. " + CTRL + SHIFT + 3", hl.dsp.exec_cmd("hyprctl switchxkblayout all 2"))
